...
layout: default
title: "Ch. 3 Quizzes"
permalink: /quizzes/chapter-03/
---

# Ch. 3 Quizzes: Discovery and Concept Planning Fundamentals

<ul class="quick-links">
  <li><a href="{{ '/study-guide/chapter-03/' | relative_url }}">Chapter 3 Study Guide</a></li>
  <li><a href="{{ '/quizzes/' | relative_url }}">All Quiz Chapters</a></li>
</ul>

<section class="quiz-list" aria-label="Chapter 3 Discovery and Concept Planning practice questions">
  <article class="quiz-card">
    <p class="quiz-meta">Chapter 3 Question 1</p>
