...
layout: default
title: "Ch. 1 Quizzes"
permalink: /quizzes/chapter-01/
---

# Ch. 1 Quizzes: Project+ Foundations and Certification Overview

<ul class="quick-links">
  <li><a href="{{ '/study-guide/chapter-01/' | relative_url }}">Chapter 1 Study Guide</a></li>
  <li><a href="{{ '/quizzes/' | relative_url }}">All Quiz Chapters</a></li>
</ul>

<section class="quiz-list" aria-label="Chapter 1 Project Foundations practice questions">
  <article class="quiz-card">
    ...
    <details class="quiz-answer">
      ...
      <p><strong>Answer: C.</strong> IT pros who need to manage small projects.</p>
    </details>
  </article>
