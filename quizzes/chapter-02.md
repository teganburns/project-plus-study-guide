...
layout: default
title: "Ch. 2 Quizzes"
permalink: /quizzes/chapter-02/
---

# Ch. 2 Quizzes: Comparing Project Management Methodologies

<ul class="quick-links">
  <li><a href="{{ '/study-guide/chapter-02/' | relative_url }}">Chapter 2 Study Guide</a></li>
...
<section class="quiz-list" aria-label="Chapter 2 Comparing Project Management Approaches practice questions">
  ...
  <article class="quiz-card">
    <p class="quiz-meta">Chapter 2 Question 4</p>
    <h2>Which of the following might be indicators that waterfall might be the right choice of approach? Choose 3.</h2>
